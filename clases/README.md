...
| 3 | [Del CSV al monitor](clase_3_pipeline_y_narrativa/) | Construir un gráfico de líneas y un bump chart desde su CSV; el pipeline completo y cómo actualizarlo | Cómo alinear narrativa y visualización: títulos, fuentes, advertencias |
